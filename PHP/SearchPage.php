...
<?php
    ...
    $stmt = $pdo -> prepare("SELECT * FROM products WHERE Name LIKE '%$searchValue%' OR Description LIKE'%$searchValue%'");
    $stmt -> execute();
    ...
    {
        echo "<center><ul class='UlHomePage'><li class='LiHomePage'>NO PRODUCTS AVALIABLE</li></ul></center>";
    }
